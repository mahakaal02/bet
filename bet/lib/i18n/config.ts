/**
 * i18n configuration (PR-BET-I18N).
 *
 * Single source of truth for which locales the bet app supports and
 * how to map an incoming visitor's country → preferred locale. Both
 * middleware (edge runtime) and React components import from here;
 * deliberately zero runtime dependencies so the bundle stays tiny.
 *
