...
const fr: Partial<Dictionary> = {
  ...
  market: {
    ...
    crumbTrade: "Trader",
    titleLead: "Tradez les",
    titleEm: "événements réels",
    subtitle:
      "Achetez OUI ou NON sur la suite des événements. Les prix bougent avec la foule et se règlent quand la vérité tombe.",
    liveMarkets: "{count} marchés en direct",
    openInterest: "{coins} pièces échangées",
    settleFast: "Réglé en quelques secondes",
    statOpen: "Ouverts",
    statVolume: "Volume",
    statNewToday: "Nouveaux",
    statResolved: "Résolus",
    paysIfYes: "Paie si OUI",
    paysIfNo: "Paie si NON",
    payoutLine: "1 pièce / part · {mult}× retour",
    pctYes: "{pct}% OUI",
    pctNo: "{pct}% NON",
    openMarket: "Ouvrir le marché",
    statusFilterLabel: "Statut",
    sortLabel: "Tri",
    topMarkets: "Marchés en vedette",
    openCountLabel: "{count} ouverts",
    sortedByLive: "Trié par {sort} · En direct",
    showingCount: "Affichage de {shown} sur {total} marchés",
    onlyFeatured: "Tous les marchés ouverts sont en vedette ci-dessus.",
    footerBrand: "kalki.bet · marchés",
    footerCompliance: "18+ · jouez de manière responsable",
    yes: "OUI",
    no: "NON",
    volume: "Volume",
    liquidity: "Liquidité",
  ...
  group: {
    ...
    chance: "Probabilité",
    buy: "Acheter",
    switchOutcome: "Changer de résultat",
    vol: "Vol",
  ...
  wallet: {
    ...
    statusGames: "Marchés · Enchères · Aviator",
    statusMethods: "UPI · Crypto · USDT",
    stepTopup: "02 · Recharger",
    stepCashout: "03 · Retrait",
    stepLedger: "04 · Registre",
    available: "Disponible",
    balanceLabel: "Solde",
    stat7dNet: "Net 7 j",
    stat7dVolume: "Volume 7 j",
    txUnit: "txn",
    complianceTitle: "Jouez de manière responsable",
    complianceBody:
      "Les marchés sont incertains. Arrêtez quand ce n'est plus amusant. Faites une pause dès que nécessaire.",
    footerBrand: "kalki · portefeuille",
    needHelp: "Besoin d'aide ?",
    chatTitle: "Secure Kalki Chat",
    chatBody:
      "Parlez à un admin pour les recharges, les paiements, le KYC et les litiges. Chiffré de bout en bout, jamais sur des plateformes tierces.",
    chatButton: "Ouvrir / Télécharger Chat",
    chatNotConfigured: "Le lien de l'application Secure Chat n'est pas encore configuré.",
    hide: "Masquer",
    show: "Afficher",
    toggleCoins: "Coins",
    toggleHidden: "Masqué",
    ...
    coinsToBuy: "Coins à acheter",
    youPay: "Vous payez",
    minTopup: "Minimum {amount} coins",
    pillTopup: "Recharge",
    pillBonus: "Bonus",
    pillReferral: "Parrainage",
    pillReward: "Récompense",
    pillDaily: "Quotidien",
    pillGrant: "Crédit",
    pillPredict: "Marché",
  ...
  withdraw: {
    ...
    subtext:
      "Retrait minimum {amount} coins. L'examen administrateur est généralement effectué le jour même.",
    estValue:
      "Vos {coins} coins valent environ {value} au prix des coins de votre région.",
    emailThresholdNote:
      "Les retraits de plus de {amount} coins nécessitent un e-mail vérifié.",
    ...
    approve: "Approuver",
    reject: "Rejeter",
    payoutRefId: "ID de référence de paiement (requis)",
    markPaid: "Marquer payé",
    approvedNote: "Approuvé — traitez le paiement en externe puis marquez comme payé.",
    rejectedNote: "Rejeté — coins remboursés.",
    paidNote: "Marqué comme payé.",
    invalidState: "Déjà décidé — actualisez la page.",
    missingReference: "Collez d'abord l'ID de référence de paiement.",
  ...
  portfolio: {
    ...
    subtitle: "Positions en direct, P&L et répartition — valorisé au prix du marché.",
    totalValue: "Valeur totale",
    pnl24: "P&L 24h",
    allTime: "Cumulé",
    winRate: "Taux de réussite",
    valueLive: "Valeur du portefeuille · en direct",
    deltaH24: "24H",
    deltaAllTime: "CUMULÉ",
    cash: "LIQUIDITÉS",
    inPositions: "EN POSITIONS",
    snapshot: "Aperçu",
    acrossCats: "sur {count} catégories",
    ...
    allTimeLc: "cumulé",
    marketsTouched: "Marchés traités",
    last30d: "30 derniers jours",
    goToMarkets: "Aller aux marchés",
    eyebrowAllocation: "02 · Répartition",
    allocationTitle: "Exposition de vos {amount} pièces",
    findMarkets: "Trouver des marchés",
    noExposure: "Pas encore d'exposition — vos positions s'afficheront ici.",
    eyebrowPositions: "03 · Positions",
    resolvedPositions: "Positions réglées",
    tabOpen: "Ouvertes",
    tabResolved: "Réglées",
    noResolved: "Aucune position réglée pour le moment.",
    colMarket: "Marché",
    colStake: "Mise",
    colAvg: "Moy.",
    colMark: "Cours",
    ...
    view: "Voir",
    close: "Fermer",
    showingPositions: "Affichage de {shown} sur {total}",
    eyebrowStreak: "04 · Série",
    dailyActivity: "Activité quotidienne",
    daysInARow: "jours d'affilée",
    daysAgo14: "il y a 14 jours",
    today: "aujourd'hui",
    eyebrowActivity: "05 · Activité",
    eyebrowBadges: "06 · Badges",
    badgesUnlocked: "{n} sur {total} débloqués",
    viewAll: "Voir tout",
    noBadges: "Aucun badge pour le moment.",
    footerBrand: "kalki.bet · portefeuille",
    streakDays: "SÉRIE DE {count} JOURS",
    openCount: "{count} OUVERTES",
    allTimeStrip: "{amount} cumulé",
  },
  ...
  watchlist: {
    ...
    titleLead: "Votre",
    titleEm: "liste de suivi",
    subtitle: "Les marchés que vous suivez, avec prix en direct et variations 24h.",
    statMarkets: "Marchés",
    statAvgMove: "Var. moy. 24h",
    statLive: "Actifs",
    statEndingSoon: "Bientôt clos",
    watchingCount: "SUIVI DE {count} MARCHÉS",
    moversStrip: "{count} ONT BOUGÉ >5% AUJOURD'HUI",
    endingStrip: "{count} SE CLÔTURENT DANS <7 JOURS",
    moversHeadline: "{count} marchés suivis ont bougé > 5% en 24h",
    allQuiet: "Calme plat sur votre liste",
    allQuietBody: "Rien de ce que vous suivez n'a bougé de plus de 5% ces 24 dernières heures.",
    seeMovers: "Voir les mouvements",
    browseMarkets: "Voir les marchés",
    searchPlaceholder: "Rechercher dans votre liste…",
    tabAll: "Tous",
    tabMovers: "Mouvements",
    tabEnding: "Bientôt clos",
    emptyLead: "Vous ne suivez encore aucun marché.",
    emptyCta: "Voir les marchés →",
    noMatches: "Aucun marché suivi ne correspond à ces filtres.",
    colMarket: "Marché",
    col7d: "7J",
    daysLeft: "{n}j",
    trade: "Trader",
    showingCount: "Affichage de {shown} sur {total} marchés suivis",
    eyebrowHot: "02 · Aujourd'hui",
    topMovers: "Plus gros mouvements",
    seeAll: "Tout voir",
    noMovers: "Aucun gros mouvement parmi vos marchés suivis.",
    eyebrowEnding: "03 · Clôture",
    endingSoonTitle: "Bientôt clos",
    noEnding: "Rien ne se clôture bientôt.",
    eyebrowForYou: "04 · Pour vous",
    suggested: "Marchés suggérés",
    noSuggestions: "Aucune suggestion pour l'instant.",
    footerBrand: "kalki.bet · favoris",
  },
  ...
  withdrawForm: {
    ...
    beneficiaryLabel: "Nom du bénéficiaire (tel qu'inscrit sur le compte)",
    bankNameLabel: "Nom de la banque",
    bankNamePlaceholder: "ex. HSBC France",
    bankCountryLabel: "Pays de la banque",
    bankCountryPlaceholder: "ex. France",
    swiftLabel: "SWIFT / BIC",
    swiftPlaceholder: "ex. CCFRFRPP",
    ibanLabel: "Numéro de compte / IBAN",
    ibanPlaceholder: "Numéro de compte ou IBAN",
    cryptoNetworkLabel: "Réseau / actif",
    cryptoAddressLabel: "Adresse du portefeuille",
    cryptoAddressPlaceholder: "Collez l'adresse de votre portefeuille",
    errInvalidWallet: "Entrez une adresse de portefeuille valide.",
    submitting: "Envoi…",
    submitButton: "Demander un retrait de {amount} coins",
    submitButtonEmpty: "Demander un retrait",
