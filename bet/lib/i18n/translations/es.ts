...
const es: Partial<Dictionary> = {
  meta: {
    ...
    eventsTitle: "Eventos — mercados de predicción de varios resultados",
    eventsDescription:
      "Explora eventos agrupados ordenados por probabilidades en vivo. Cada candidato es su propio mercado SÍ/NO: compara las opciones y opera el resultado en el que crees.",
  ...
  market: {
    ...
    crumbTrade: "Operar",
    titleLead: "Opera sobre",
    titleEm: "eventos del mundo real",
    subtitle:
      "Compra SÍ o NO sobre lo que pasará. Los precios se mueven con la multitud y se liquidan cuando llega la verdad.",
    liveMarkets: "{count} mercados en vivo",
    openInterest: "{coins} monedas negociadas",
    settleFast: "Se liquida en segundos",
    statOpen: "Abiertos",
    statVolume: "Volumen",
    statNewToday: "Nuevos hoy",
    statResolved: "Resueltos",
    paysIfYes: "Paga si SÍ",
    paysIfNo: "Paga si NO",
    payoutLine: "1 moneda / acción · {mult}× retorno",
    pctYes: "{pct}% SÍ",
    pctNo: "{pct}% NO",
    openMarket: "Abrir mercado",
    statusFilterLabel: "Estado",
    sortLabel: "Orden",
    topMarkets: "Mercados destacados",
    openCountLabel: "{count} abiertos",
    sortedByLive: "Ordenado por {sort} · En vivo",
    showingCount: "Mostrando {shown} de {total} mercados",
    onlyFeatured: "Todos los mercados abiertos están destacados arriba.",
    footerBrand: "kalki.bet · mercados",
    footerCompliance: "+18 · juega con responsabilidad",
    yes: "SÍ",
    no: "NO",
    volume: "Volumen",
    liquidity: "Liquidez",
  ...
  group: {
    ...
    showLess: "Ver menos",
    empty: "Aún no hay candidatos en este evento.",
    notFound: "Evento no encontrado",
    titleLead: "Explora",
    titleEm: "cada evento",
    subtitle: "Mercados de múltiples resultados agrupados por evento — elige un lado en cualquier candidato.",
    statEvents: "Eventos",
  ...
  wallet: {
    ...
    statusGames: "Mercados · Subastas · Aviator",
    statusMethods: "UPI · Cripto · USDT",
    stepTopup: "02 · Recargar",
    stepCashout: "03 · Retirar",
    stepLedger: "04 · Registro",
    available: "Disponible",
    balanceLabel: "Saldo",
    stat7dNet: "Neto 7 d",
    stat7dVolume: "Volumen 7 d",
    txUnit: "txn",
    complianceTitle: "Juega de forma responsable",
    complianceBody:
      "Los mercados son inciertos. Detente cuando deje de ser divertido. Tómate un descanso cuando lo necesites.",
    footerBrand: "kalki · billetera",
    needHelp: "¿Necesitas ayuda?",
    chatTitle: "Secure Kalki Chat",
    chatBody:
      "Habla con un admin para recargas, pagos, KYC y disputas. Cifrado de extremo a extremo, nunca en plataformas de terceros.",
    chatButton: "Abrir / Descargar Chat",
    chatNotConfigured: "El enlace de la app Secure Chat aún no está configurado.",
    hide: "Ocultar",
    show: "Mostrar",
    toggleCoins: "Monedas",
    toggleHidden: "Oculto",
    ...
    choosePack: "Elegir un paquete",
    coinsToBuy: "Monedas a comprar",
    youPay: "Pagas",
    minTopup: "Mínimo {amount} monedas",
    pillTopup: "Recarga",
    pillBonus: "Bono",
    pillReferral: "Referido",
  ...
  withdraw: {
    ...
    subtext:
      "Retiro mínimo de {amount} monedas. La revisión del admin suele ser el mismo día.",
    estValue:
      "Tus {coins} monedas valen aproximadamente {value} al precio de monedas de tu región.",
    emailThresholdNote:
      "Los retiros de más de {amount} monedas requieren un correo verificado.",
    ...
    approve: "Aprobar",
    reject: "Rechazar",
    payoutRefId: "ID de referencia de pago (obligatorio)",
    markPaid: "Marcar como pagado",
    approvedNote: "Aprobado — procesa el pago externamente y luego marca como pagado.",
    rejectedNote: "Rechazado — monedas reembolsadas.",
    paidNote: "Marcado como pagado.",
    invalidState: "Ya decidido — recarga la página.",
    missingReference: "Pega primero el ID de referencia de pago.",
  ...
  portfolio: {
    ...
    titleLead: "Tu",
    titleEm: "portafolio",
    subtitle: "Posiciones en vivo, P&L y asignación — valorado a mercado con precios en vivo.",
    totalValue: "Valor total",
    pnl24: "P&L 24h",
    allTime: "Histórico",
    winRate: "Tasa de acierto",
    valueLive: "Valor del portafolio · en vivo",
    deltaH24: "24H",
    deltaAllTime: "HISTÓRICO",
    cash: "EFECTIVO",
    inPositions: "EN POSICIONES",
    snapshot: "Resumen",
    acrossCats: "en {count} categorías",
    ...
    goToMarkets: "Ir a mercados",
    eyebrowAllocation: "02 · Asignación",
    allocationTitle: "Cómo están expuestas tus {amount} monedas",
    findMarkets: "Buscar mercados",
    noExposure: "Aún sin exposición abierta — tus posiciones aparecerán aquí.",
    eyebrowPositions: "03 · Posiciones",
    resolvedPositions: "Posiciones resueltas",
    tabOpen: "Abiertas",
    tabResolved: "Resueltas",
    noResolved: "Aún no hay posiciones resueltas.",
    colMarket: "Mercado",
    colStake: "Apuesta",
    colAvg: "Prom.",
    colMark: "Actual",
    ...
    eyebrowStreak: "04 · Racha",
    dailyActivity: "Actividad diaria",
    daysInARow: "días seguidos",
    daysAgo14: "hace 14 días",
    today: "hoy",
    eyebrowActivity: "05 · Actividad",
    eyebrowBadges: "06 · Insignias",
    badgesUnlocked: "{n} de {total} desbloqueadas",
    viewAll: "Ver todas",
    noBadges: "Aún sin insignias.",
    footerBrand: "kalki.bet · portafolio",
  ...
  watchlist: {
    ...
    titleLead: "Tu",
    titleEm: "lista de seguimiento",
    subtitle: "Mercados que sigues, con precios en vivo y movimientos de 24h.",
    statMarkets: "Mercados",
    statAvgMove: "Mov. medio 24h",
    statLive: "Activos",
    statEndingSoon: "Cierran pronto",
    watchingCount: "SIGUIENDO {count} MERCADOS",
    moversStrip: "{count} MOVIERON >5% HOY",
    endingStrip: "{count} CIERRAN EN <7 DÍAS",
    moversHeadline: "{count} mercados seguidos movieron > 5% en 24h",
    allQuiet: "Todo tranquilo en tu lista",
    allQuietBody: "Nada de lo que sigues se movió más de 5% en las últimas 24 horas.",
    seeMovers: "Ver movimientos",
    browseMarkets: "Ver mercados",
    searchPlaceholder: "Busca en tu lista…",
    tabAll: "Todos",
    tabMovers: "Movimientos",
    tabEnding: "Cierran pronto",
    emptyLead: "Aún no sigues ningún mercado.",
    emptyCta: "Ver mercados →",
    noMatches: "Ningún mercado seguido coincide con estos filtros.",
    colMarket: "Mercado",
    col7d: "7D",
    daysLeft: "{n}d",
    trade: "Operar",
    showingCount: "Mostrando {shown} de {total} mercados seguidos",
    eyebrowHot: "02 · Hoy",
    topMovers: "Mayores movimientos",
    seeAll: "Ver todo",
    noMovers: "Sin grandes movimientos en tus mercados seguidos.",
    eyebrowEnding: "03 · Cierran",
    endingSoonTitle: "Cierran pronto",
    noEnding: "Nada cierra pronto.",
    eyebrowForYou: "04 · Para ti",
    suggested: "Mercados sugeridos",
    noSuggestions: "Sin sugerencias por ahora.",
    footerBrand: "kalki.bet · lista",
  },
  ...
  withdrawForm: {
    amountLabel: "Monto (monedas)",
    amountMinMax: "mín. {min} · máx. {max}",
    amountPayout: "{amount} monedas",
    ...
    beneficiaryLabel: "Nombre del beneficiario (como en la cuenta)",
    bankNameLabel: "Nombre del banco",
    bankNamePlaceholder: "ej. BBVA",
    bankCountryLabel: "País del banco",
    bankCountryPlaceholder: "ej. España",
    swiftLabel: "SWIFT / BIC",
    swiftPlaceholder: "ej. BBVAESMM",
    ibanLabel: "Número de cuenta / IBAN",
    ibanPlaceholder: "Número de cuenta o IBAN",
    cryptoNetworkLabel: "Red / activo",
    cryptoAddressLabel: "Dirección de la billetera",
    cryptoAddressPlaceholder: "Pega la dirección de tu billetera",
    errInvalidWallet: "Introduce una dirección de billetera válida.",
    submitting: "Enviando…",
    submitButton: "Solicitar retiro de {amount} monedas",
    submitButtonEmpty: "Solicitar retiro",
