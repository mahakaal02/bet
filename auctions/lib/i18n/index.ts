/**
 * i18n public API (PR-AUCTIONS-I18N).
 *
 ...
 *
 * Usage:
 *   t('nav.auctions', 'pt')              → "Leilões"
 *   t('auction.endsAt', 'en', { time: '5m' })
 *                                        → "Ends in 5m"
 ...
 *
 *   /pt/auctions       → { locale: 'pt', rest: '/auctions' }
 *   /en                → { locale: 'en', rest: '/' }
 *   /auctions          → { locale: null, rest: '/auctions' }
 *   /                  → { locale: null, rest: '/' }
 *
 ...
 * localized path (e.g. `/pt/auctions`) replaces the existing locale
 * rather than nesting (`/en/pt/auctions`).
 *
 *   localizedPath('/auctions', 'pt')      → '/pt/auctions'
 *   localizedPath('/en/auctions', 'pt')   → '/pt/auctions'
 *   localizedPath('/',  'fr')             → '/fr'
 */
 ...
 *
 *   alternatesFor('https://example.com', '/auctions')
 *   → {
 *       en: 'https://example.com/en/auctions',
 *       pt: 'https://example.com/pt/auctions',
 *       ...
 *       'x-default': 'https://example.com/en/auctions'
 *     }
 *
