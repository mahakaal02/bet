...
/**
 * Localized route layout (PR-AUCTIONS-I18N).
 *
 ...
 *   5. Provide the title template (`%s · Kalki Auctions`) inherited
...
export async function generateMetadata({
  ...
  // here means a child page returning `title: "Auctions"` ends up as
  // `Auctions · Kalki Auctions` in the browser tab.
  ...
  return {
    ...
    metadataBase: new URL(
      (process.env.NEXT_PUBLIC_AUCTIONS_URL ?? "http://localhost:3200").replace(
        /\/$/,
        "",
      ),
    ),
