    ...
    <main className="min-h-screen pb-20">
      ...
      <div className="mx-auto max-w-2xl px-4 py-6">
        ...
        <Card className="mb-4">
          ...
          >
            <span>
              ...
              <span className="text-[11px] text-slate-500">
                Verify identity to unlock higher withdrawal limits
              </span>
            </span>
            <span aria-hidden className="text-slate-500">
              →
        ...
        <Card className="mb-4">
          ...
          >
            <span>
              <span className="block font-medium">Share your code</span>
              <span className="text-[11px] text-slate-500">
                Earn coins when a friend signs up and tops up
              </span>
            </span>
            <span aria-hidden className="text-slate-500">
              →
        ...
        <Card className="mb-4">
          ...
          >
            <span>
              <span className="block font-medium">Track shipments</span>
              <span className="text-[11px] text-slate-500">
                Items you've won — pick an address, watch them arrive
              </span>
            </span>
            <span aria-hidden className="text-slate-500">
              →
