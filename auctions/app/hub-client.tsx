      ...
      <div className="khub-page">
        ...
        <nav className="nav">
          ...
          <div className="nav-right">
            <a className="wallet-pill" href={links.wallet} aria-label="Wallet">
              <span className="amt">{balDisplay}</span>
              <span>{tr("nav_coins")}</span>
              <span className="plus" aria-label="Top up">+</span>
            </a>

            <a className="icon-btn" href="/me/watchlist" aria-label="Watchlist">
            ...
            <a className="icon-btn" href="/notifications" aria-label="Notifications">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className="ic">
        ...
        <section className="games">
          ...
          {/* AUCTIONS */}
          <a className="game auctions" href={links.auction} tabIndex={0}>
          ...
          {/* AVIATOR */}
          <a className="game aviator" href={links.aviator} tabIndex={0}>
            <div className="game-top">
              <div className="game-tag">
                <div className="game-icon">
          ...
          {/* EXCHANGE */}
          <a className="game exchange" href={links.exchange} tabIndex={0}>
            <div className="game-top">
              <div className="game-tag">
                <div className="game-icon">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className="ic">
        ...
        <section className="hot">
          ...
          {recentAuctions.slice(0, 2).map((a) => (
            <a key={a.id} className="hot-chip gold" href={`/auctions/${a.id}`}>
              <span className="dot" />
          ...
          {recentMarkets.slice(0, 2).map((m) => (
            <a key={m.id} className="hot-chip blue" href={marketHref(m, links)}>
              <span className="dot" />
              <span className="em">📈</span>
              &nbsp;<span>{m.title}</span>
            </a>
        ...
        <section className="below">
          <div className="panel">
            <div className="panel-head">
              ...
              <a className="panel-link" href="/profile">{tr("activity_link")}</a>
            </div>
