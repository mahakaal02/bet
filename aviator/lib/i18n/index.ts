/**
 * i18n public API (PR-AVIATOR-I18N).
 *
 ...
 *
 *   /pt/profile        → { locale: 'pt', rest: '/profile' }
 *   /en                → { locale: 'en', rest: '/' }
 ...
 * localized path (e.g. `/pt/profile`) replaces the existing locale
 * rather than nesting (`/en/pt/profile`).
 *
 *   localizedPath('/profile', 'pt')        → '/pt/profile'
 *   localizedPath('/en/profile', 'pt')     → '/pt/profile'
 *   localizedPath('/',  'fr')              → '/fr'
 */
 ...
 *
 *   alternatesFor('https://example.com', '/fairness')
 *   → {
 *       en: 'https://example.com/en/fairness',
 *       pt: 'https://example.com/pt/fairness',
 *       ...
 *       'x-default': 'https://example.com/en/fairness'
 *     }
 *
